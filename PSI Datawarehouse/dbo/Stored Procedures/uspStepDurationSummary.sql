CREATE PROCEDURE [dbo].[uspStepDurationSummary]
	
AS
	Begin Try
		Truncate table Reporting.StepDurationSummary
		Insert into Reporting.StepDurationSummary 
		(
		Account,
		StepName ,
		[Less Than 1 Minute],
		...
		[Greater Than 20 Minutes]
			...
			from
			(
			select TestSessionId, account, stepname,
			 case 
			 ...
			 group by  a.Account, a.stepname;

		Update Reporting.StepDurationSummary
		set [Total For Step] =
			[Less Than 1 Minute] +
			[One to 5 minutes] +
			[Five To 7.5 Minutes] +
