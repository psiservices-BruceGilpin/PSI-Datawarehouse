CREATE TABLE [CAI].[DailyStudentTestSummary]
(
    ...
    [SummaryTestTitle] VARCHAR(200) NOT NULL, 
...
CREATE INDEX [IX_CAIStudentTestSummary_DWStudentKey] ON [CAI].[DailyStudentTestSummary] ([DWStudentKey])
GO

CREATE INDEX [IX_CAIStudentTestSummary_DWTestKey] ON [CAI].[DailyStudentTestSummary] ([DWTestKey])

GO

CREATE INDEX [IX_CAIStudentTestSummary_StudentTest] ON [CAI].[DailyStudentTestSummary] ([DWStudentkey], [DWTestKey])
include (TestDate)

GO

CREATE INDEX [IX_CAIStudentTestSummary_TestDate] ON [CAI].[DailyStudentTestSummary] ([TestDate])
